...
const {ClaimRepository, CollectableWinnerRepository, EligibleClaimantRepository} = require("./../repositories");
...
class ClaimController extends Controller {
    async show(req, res) {
        ...
        let data = await ClaimRepository
    ...
    async claim(req, res) {
      ...
      let claimant = await EligibleClaimantRepository.findByAddress(contractAddress, wallet_address);
      if (!claimant) {
