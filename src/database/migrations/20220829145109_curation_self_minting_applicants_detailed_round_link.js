...
exports.up = (knex) => knex.schema.alterTable(CURATION_SELF_MINTING_APPLICANTS_VOTES_TABLE, table => {
...
exports.down = (knex) =>
  knex.schema.alterTable(CURATION_SELF_MINTING_APPLICANTS_VOTES_TABLE, (table) => {
